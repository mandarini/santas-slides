...
<div class="abs-bl m-6 flex items-center gap-2 text-white/80">
  <carbon:location-filled class="text-red-400" />
...
- <logos-supabase-icon /> Software Engineer at **Supabase**
- <logos-google-maps /> **Google Developer Expert** for Angular & Maps
- <twemoji-cat /> Loves cats, chocolate, and being on stage
- <carbon-globe /> psyber.city | @psybercity

</v-clicks>

<div v-click class="mt-8 p-4 bg-green-900/30 rounded-lg border border-green-500/50">
  <carbon-idea class="text-yellow-400 inline" /> Today: Building a <span class="text-red-400 font-bold">real-time Christmas treasure hunt</span> with Supabase + Google Maps!
</div>
...
<div class="h-full flex items-center justify-center">
  <div class="text-center">
    <logos-supabase-icon class="text-9xl mb-4" />
...
# Supabase: What's Inside? <carbon-box class="inline text-green-400" />
...
<div v-click class="p-4 bg-gradient-to-br from-green-900/40 to-green-900/10 rounded-lg border border-green-500/30">
  <div class="flex items-center gap-2 mb-2">
    <carbon-data-base class="text-green-400 text-xl" />
...
<div v-click class="p-4 bg-gradient-to-br from-red-900/40 to-red-900/10 rounded-lg border border-red-500/30">
  <div class="flex items-center gap-2 mb-2">
    <carbon-locked class="text-red-400 text-xl" />
...
<div v-click class="p-4 bg-gradient-to-br from-blue-900/40 to-blue-900/10 rounded-lg border border-blue-500/30">
  <div class="flex items-center gap-2 mb-2">
    <carbon-cloud-upload class="text-blue-400 text-xl" />
...
<div v-click class="p-4 bg-gradient-to-br from-purple-900/40 to-purple-900/10 rounded-lg border border-purple-500/30">
  <div class="flex items-center gap-2 mb-2">
    <carbon-function class="text-purple-400 text-xl" />
...
<div v-click class="p-4 bg-gradient-to-br from-yellow-900/40 to-yellow-900/10 rounded-lg border border-yellow-500/30">
  <div class="flex items-center gap-2 mb-2">
    <carbon-lightning class="text-yellow-400 text-xl" />
...
<div v-click class="p-4 bg-gradient-to-br from-cyan-900/40 to-cyan-900/10 rounded-lg border border-cyan-500/30">
  <div class="flex items-center gap-2 mb-2">
    <carbon-api class="text-cyan-400 text-xl" />
...
<div v-click class="text-center">
  <div class="w-20 h-20 mx-auto mb-4 rounded-full bg-yellow-500/20 flex items-center justify-center">
    <carbon-lightning class="text-4xl text-yellow-400" />
  </div>
...
<div v-click class="text-center">
  <div class="w-20 h-20 mx-auto mb-4 rounded-full bg-purple-500/20 flex items-center justify-center">
    <carbon-function class="text-4xl text-purple-400" />
  </div>
...
<div v-click class="text-center">
  <div class="w-20 h-20 mx-auto mb-4 rounded-full bg-green-500/20 flex items-center justify-center">
    <carbon-location class="text-4xl text-green-400" />
  </div>
...
<div v-click class="mt-8 text-center">
  <div class="inline-flex items-center gap-2 px-6 py-3 bg-green-900/30 rounded-full border border-green-500/50">
    <carbon-idea class="text-yellow-400" />
...
# Realtime in Action <carbon-lightning class="inline text-yellow-400" />
...
<div v-click class="mt-4 p-3 bg-yellow-900/20 rounded border border-yellow-500/30 text-sm">
  <carbon-flow class="text-yellow-400 inline mr-2" />
...
# PostGIS: Geospatial Superpowers <carbon-earth-filled class="inline text-green-400" />
...
- <carbon-data-structured class="text-green-400 inline" /> Efficient storage of geographic types
  - Point, Polygon, LineString
- <carbon-flash class="text-yellow-400 inline" /> Spatial indexing for **blazing fast** queries
- <carbon-rule class="text-blue-400 inline" /> Real Earth geometry calculations
- <carbon-area class="text-purple-400 inline" /> Polygon containment checks
...
<div class="mt-4 text-sm text-gray-400">
  <carbon-location-filled class="text-red-400 inline" /> Spitalfields Market, London
</div>
...
<div class="text-6xl my-6">
  <logos-google-maps class="text-8xl" />
</div>
...
# What Can You Do With Google Maps Platform? <logos-google-maps class="inline" />
...
<div class="mt-4 space-y-2 text-sm">
  <div v-click class="flex items-center gap-2">
    <carbon-checkmark class="text-green-400" />
...
# Feature #2: Geometry Library <carbon-rule class="inline text-yellow-400" />
...
<div class="mt-2 p-2 bg-blue-900/30 rounded text-sm">
  <carbon-information class="text-blue-400 inline mr-1" />
...
<div class="mt-2 p-2 bg-green-900/30 rounded text-sm">
  <carbon-information class="text-green-400 inline mr-1" />
...
<div v-click class="mt-8 text-center">
  <div class="inline-block px-6 py-3 bg-gradient-to-r from-green-900/50 to-blue-900/50 rounded-full">
    <carbon-earth class="text-green-400 inline mr-2" />
...
# Feature #3: WebGL Overlay View <carbon-cube class="inline text-purple-400" />
...
<div class="mt-4 space-y-2 text-sm">
  ...
  <div v-click class="flex items-center gap-2">
    <carbon-devices class="text-green-400" />
    Reusable across platforms
  </div>
  <div v-click class="flex items-center gap-2">
    <carbon-reset class="text-yellow-400" />
    Live updates without redeployment
  </div>
  <div v-click class="flex items-center gap-2">
    <carbon-contrast class="text-purple-400" />
...
<div v-click class="h-full flex items-center">
  <div class="w-full p-4 bg-gradient-to-br from-red-900/30 to-green-900/30 rounded-lg border border-white/20">
    <div class="text-center mb-3 text-lg font-bold text-yellow-400">
      <carbon-paint-brush class="inline mr-2" />
      Christmas Theme?
    </div>
...
# Feature #5: 3D Maps (Photorealistic Tiles) <carbon-3d-mpr-toggle class="inline text-cyan-400" />
...
<div v-click class="flex items-center justify-center">
  <div class="text-center">
    ...
    <div class="mt-4 text-xs text-gray-500">
      <carbon-location-filled class="inline text-red-400" /> Spitalfields Market fly-around demo
    </div>
  </div>
</div>
...
# The Magic: Google Maps + AI <carbon-machine-learning class="inline text-cyan-400" />
...
<div v-click class="mt-6 p-4 bg-yellow-900/20 rounded-lg border border-yellow-500/30 text-center">
  <carbon-idea class="text-yellow-400 text-2xl inline mr-2" />
...
<div v-click class="mt-4 p-3 bg-green-900/30 rounded border border-green-500/30">
  <carbon-arrow-right class="text-green-400 inline mr-2" />
...
<div v-click class="h-full flex items-center justify-center">
  <div class="p-6 bg-gradient-to-br from-purple-900/40 to-blue-900/40 rounded-xl border border-purple-500/30">
    <div class="flex items-center gap-4 mb-4">
      ...
      <div class="text-5xl">+</div>
      <logos-google-maps class="text-5xl" />
    </div>
...
<div v-click class="mt-8 text-xl text-green-400">
  <carbon-trophy class="inline mr-2" />
...
# Behind the Scenes: How It Works <carbon-flow class="inline text-blue-400" />
...
<div class="space-y-3 mt-4">
  <div class="flex items-start gap-2">
    <carbon-checkmark-filled class="text-green-400 mt-1" />
    <div>
  ...
  <div class="flex items-start gap-2">
    <carbon-checkmark-filled class="text-purple-400 mt-1" />
    <div>
  ...
  <div class="flex items-start gap-2">
    <carbon-checkmark-filled class="text-blue-400 mt-1" />
    <div>
  ...
  <div class="flex items-start gap-2">
    <carbon-checkmark-filled class="text-yellow-400 mt-1" />
    <div>
...
# Three Game Modes Explained <carbon-game-console class="inline text-purple-400" />
...
<div v-click class="p-6 bg-gradient-to-b from-blue-900/40 to-transparent rounded-xl border border-blue-500/30 text-center">
  ...
  <ul class="text-sm text-left text-gray-300 space-y-2">
    <li><carbon-location class="inline text-blue-400" /> Fixed target location</li>
    <li><carbon-trophy class="inline text-yellow-400" /> First to get within 1km wins</li>
    <li><carbon-code class="inline text-gray-400" /> Uses `computeDistanceBetween()`</li>
  </ul>
</div>
...
<div v-click class="p-6 bg-gradient-to-b from-green-900/40 to-transparent rounded-xl border border-green-500/30 text-center">
  ...
  <ul class="text-sm text-left text-gray-300 space-y-2">
    <li><carbon-movement class="inline text-green-400" /> Target moves every 20s!</li>
    <li><carbon-time class="inline text-yellow-400" /> Powered by pg_cron</li>
    <li><carbon-warning class="inline text-orange-400" /> Keeps everyone on their toes</li>
  </ul>
</div>
...
<div v-click class="p-6 bg-gradient-to-b from-red-900/40 to-transparent rounded-xl border border-red-500/30 text-center">
  ...
  <ul class="text-sm text-left text-gray-300 space-y-2">
    <li><carbon-group class="inline text-red-400" /> Collaborative gameplay</li>
    <li><carbon-search class="inline text-yellow-400" /> Find hidden gift polygon</li>
    <li><carbon-checkmark class="inline text-green-400" /> 10 players inside = all win!</li>
  </ul>
</div>
...
<div v-click class="mt-6 text-center text-gray-400 text-sm">
  <carbon-code class="inline mr-1" /> Polygon Hunt uses <code class="text-purple-400">containsLocation()</code> for boundary checking
</div>
...
# Code Deep Dive: Distance Calculation <carbon-code class="inline text-green-400" />
...
# Code Deep Dive: Polygon Containment <carbon-area class="inline text-purple-400" />
...
<div v-click class="mt-4 p-3 bg-purple-900/30 rounded border border-purple-500/30 text-sm">
  <carbon-idea class="text-yellow-400 inline mr-2" />
...
# Code Deep Dive: WebGL Present Overlay <carbon-cube class="inline text-cyan-400" />
...
# Code Deep Dive: Realtime Subscriptions <carbon-lightning class="inline text-yellow-400" />
...
<div v-click class="mt-4 p-3 bg-yellow-900/30 rounded border border-yellow-500/30">
  <carbon-information class="text-yellow-400 inline mr-2" />
...
# The Edge Functions Magic <carbon-function class="inline text-purple-400" />
...
<div v-click class="absolute bottom-4 right-4 text-sm text-gray-400">
  <carbon-globe class="inline mr-1 text-purple-400" /> Runs on Deno at the edge, close to your users
</div>
...
# Performance at Scale <carbon-rocket class="inline text-green-400" />
...
<div class="space-y-4">
  <div v-click class="flex items-center gap-3 p-3 bg-green-900/30 rounded-lg">
    <carbon-data-base class="text-3xl text-green-400" />
    <div>
  ...
  <div v-click class="flex items-center gap-3 p-3 bg-blue-900/30 rounded-lg">
    <carbon-location-star class="text-3xl text-blue-400" />
    <div>
  ...
  <div v-click class="flex items-center gap-3 p-3 bg-yellow-900/30 rounded-lg">
    <carbon-lightning class="text-3xl text-yellow-400" />
    <div>
...
<div class="space-y-4">
  <div v-click class="flex items-center gap-3 p-3 bg-purple-900/30 rounded-lg">
    <carbon-globe class="text-3xl text-purple-400" />
    <div>
  ...
  <div v-click class="flex items-center gap-3 p-3 bg-cyan-900/30 rounded-lg">
    <carbon-timer class="text-3xl text-cyan-400" />
    <div>
  ...
  <div v-click class="flex items-center gap-3 p-3 bg-gradient-to-r from-green-900/50 to-yellow-900/50 rounded-lg border border-green-500/50">
    <carbon-checkmark-filled class="text-3xl text-green-400" />
    <div>
...
# Real-World Use Cases <carbon-industry class="inline text-blue-400" />
...
# Key Takeaways <carbon-bookmark class="inline text-yellow-400" />

<div class="grid grid-cols-3 gap-8 mt-8 max-w-4xl">

<div v-click class="text-center">
  <div class="w-20 h-20 mx-auto mb-4 rounded-full bg-green-500/20 flex items-center justify-center">
    <logos-supabase-icon class="text-4xl" />
  </div>
...
<div v-click class="text-center">
  <div class="w-20 h-20 mx-auto mb-4 rounded-full bg-blue-500/20 flex items-center justify-center">
    <logos-google-maps class="text-4xl" />
  </div>
...
<div v-click class="text-center">
  <div class="w-20 h-20 mx-auto mb-4 rounded-full bg-purple-500/20 flex items-center justify-center">
    <carbon-flash class="text-4xl text-purple-400" />
  </div>
...
# Resources & Links <carbon-link class="inline text-blue-400" />

<div class="grid grid-cols-2 gap-8 mt-6">

<div>

### <logos-supabase-icon class="inline" /> Supabase

<div class="space-y-2 mt-4">
  <a href="https://supabase.com" class="block p-2 bg-white/5 rounded hover:bg-white/10 transition">
    <carbon-arrow-right class="inline text-green-400 mr-2" /> supabase.com
  </a>
  <a href="https://supabase.com/docs/guides/realtime" class="block p-2 bg-white/5 rounded hover:bg-white/10 transition">
    <carbon-arrow-right class="inline text-green-400 mr-2" /> Realtime Docs
  </a>
  <a href="https://supabase.com/docs/guides/database/extensions/postgis" class="block p-2 bg-white/5 rounded hover:bg-white/10 transition">
    <carbon-arrow-right class="inline text-green-400 mr-2" /> PostGIS Guide
  </a>
</div>
...
### <logos-google-maps class="inline" /> Google Maps Platform
...
<div class="space-y-2 mt-4">
  <a href="https://developers.google.com/maps/documentation/javascript/advanced-markers/overview" class="block p-2 bg-white/5 rounded hover:bg-white/10 transition">
    <carbon-arrow-right class="inline text-blue-400 mr-2" /> Advanced Markers
  </a>
  <a href="https://developers.google.com/maps/documentation/javascript/geometry" class="block p-2 bg-white/5 rounded hover:bg-white/10 transition">
    <carbon-arrow-right class="inline text-blue-400 mr-2" /> Geometry Library
  </a>
  <a href="https://developers.google.com/maps/documentation/javascript/webgl" class="block p-2 bg-white/5 rounded hover:bg-white/10 transition">
    <carbon-arrow-right class="inline text-blue-400 mr-2" /> WebGL Overlay View
  </a>
  <a href="https://github.com/googlemaps/platform-ai" class="block p-2 bg-white/5 rounded hover:bg-white/10 transition">
    <carbon-arrow-right class="inline text-purple-400 mr-2" /> Google Maps MCP
  </a>
</div>
...
# Bonus: Architecture Diagram <carbon-diagram class="inline text-blue-400" />
...
# Bonus: Cost Optimization Tips <carbon-piggy-bank class="inline text-green-400" />
...
<div v-click class="p-6 bg-gradient-to-br from-green-900/30 to-green-900/10 rounded-xl border border-green-500/30">
  <div class="flex items-center gap-3 mb-4">
    <logos-supabase-icon class="text-3xl" />
...
<div v-click class="p-6 bg-gradient-to-br from-blue-900/30 to-blue-900/10 rounded-xl border border-blue-500/30">
  <div class="flex items-center gap-3 mb-4">
    <logos-google-maps class="text-3xl" />
...
# Bonus: Development Workflow Tips <carbon-terminal class="inline text-cyan-400" />
...
<div v-click class="mt-6 text-center p-3 bg-gradient-to-r from-green-900/50 to-cyan-900/50 rounded-lg border border-green-500/50">
  <carbon-flash class="text-yellow-400 inline mr-2" />
